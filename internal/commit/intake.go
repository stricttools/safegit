...
// bounds the whole preservation of another session's staged state: whatever the
// shared index held at one of these paths -- a slot, or the absence of one --
// is a claim this commit has just settled by recording bytes there, rather than
// work to put back on top of what it recorded. See git.ReconcileMainIndex.
